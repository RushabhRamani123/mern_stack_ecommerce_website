      ...
      <motion.div
        ...
        <Slider {...settings}>
          <div style={{ position: 'relative' , width: '100%', height: '80vh', borderRadius: '0.75rem' }}>
            <img src={slider1} alt="slider" style={{ width: window.innerWidth < 821 ? '55vh' :'145vh', height: window.innerWidth< 821 ?'50vh':'85vh', borderRadius: '0.75rem' }} />
            <div>
              ...
              <h1 style={{ position: 'absolute', top: '10rem', left: '5rem', fontSize: '3rem' }}>Tech Trending<br />
                <span style={{ fontSize: '3rem' , color: '#088178'}}>
          ...
          <div>
            <img src={slider} alt="slider" style={{ width: window.innerWidth < 821 ? '55vh' :'145vh', height: window.innerWidth<821?'50vh':'85vh', borderRadius: '0.75rem' }} />
            <div>
